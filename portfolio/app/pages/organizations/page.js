...
const organizations = [

  {
    ...
    details: [{ label: "Position Held", value: "Co-Director" }],
...

  {
    ...
    details: [{ label: "Position Held", value: "Family Head" }],
...

  {
    ...
    details: [{ label: "Position Held", value: "Member" }],
  ...
  const handleNext = () => setActiveIndex((prev) => (prev + 1) % organizations.length)
  const handlePrev = () => setActiveIndex((prev) => (prev - 1 + organizations.length) % organizations.length)
